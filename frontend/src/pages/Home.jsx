  ...
  return (
    <PublicLayout>
      ...
      <section className="relative overflow-hidden" data-testid="home-hero">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10 py-32 md:py-44 grid md:grid-cols-12 gap-8 text-[#F7F5F0]">
          <motion.div
          ...
          >
            ...
            <p className="text-lg md:text-xl max-w-2xl text-[#F7F5F0]/80 font-light leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              ...
              <Link
                ...
                style={{ color: "#F7F5F0", borderColor: "#F7F5F0" }}
          ...
          >
            <div className="font-kanji text-7xl md:text-8xl lg:text-9xl text-[#C1121F] leading-none" aria-hidden>
              {c.kanji || "空手道"}
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 pb-24 md:pb-32">
        <div className="grid md:grid-cols-3 gap-0 border border-[#E0DCD0]">
          {[
            ...
            <motion.div
              ...
              className={`p-10 ${i < 2 ? "md:border-r border-[#E0DCD0]" : ""} ${i > 0 ? "border-t md:border-t-0 border-[#E0DCD0]" : ""}`}
            >
              <div className="font-kanji text-5xl text-[#C1121F] mb-4">{p.kanji}</div>
      ...
      {/* CTA strip */}
      <section className="bg-[#1A1A1A] text-[#F7F5F0]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-20 md:py-24 grid md:grid-cols-[1fr_auto] gap-8 items-center">
          <div>
            <div className="text-[10px] uppercase tracking-[0.32em] text-[#F7F5F0]/60 mb-3">Begin your practice</div>
            <h2 className="font-serif text-4xl md:text-5xl tracking-tight">Step onto the tatami.</h2>
          </div>
          <div className="flex gap-4">
            <Link to="/contact" className="btn-outline" style={{ color: "#F7F5F0", borderColor: "#F7F5F0" }} data-testid="home-cta-contact">
              Visit Dojo
            </Link>
